...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (act2          (if (eq variant 'dark) (if (true-color-p) "#20242f" "#444444") (if (true-color-p) "#d3d3e7" "#afafd7")))
        ...
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#282c37" "#1c1c1c") (if (true-color-p) "#efeae9" "#e4e4e4")))
        (bg3           (if (eq variant 'dark) (if (true-color-p) "#20242f" "#121212") (if (true-color-p) "#e3dedd" "#d0d0d0")))
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#181c27" "#080808") (if (true-color-p) "#d2ceda" "#bcbcbc")))
        ...
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#20242f" "#262626") (if (true-color-p) "#e8e3f0" "#ffffff")))
        (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#fec7cd" "#af5faf") (if (true-color-p) "#9380b2" "#af5fdf")))
        (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#181c27" "#333333") (if (true-color-p) "#ddd8eb" "#dfdfff")))
        ...
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#20242f" "#444444") (if (true-color-p) "#d3d3e7" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#282c37" "#444444") (if (true-color-p) "#e7e7fc" "#d7d7ff")))
        ...
        (ttip-sl       (if (eq variant 'dark) (if (true-color-p) "#181c27" "#333333") (if (true-color-p) "#c8c6dd" "#afafff")))
        (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#20242f" "#444444") (if (true-color-p) "#e2e0ea" "#dfdfff")))

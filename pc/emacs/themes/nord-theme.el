...
(let ((class '((class color) (min-colors 89)))
  (nord0 (if (nord-display-truecolor-or-graphic-p) "#000507" nil))
  (nord1 (if (nord-display-truecolor-or-graphic-p) "#0D1319" "black"))
  (nord2 (if (nord-display-truecolor-or-graphic-p) "#151D25" "#151D25"))
  (nord3 (if (nord-display-truecolor-or-graphic-p) "#1E2731" "brightblack"))
  ...
  (nord-region-highlight-foreground (if (or
    ...
    (string= nord-region-highlight "snowstorm")) "#000507" nil))
  (nord-region-highlight-background (if
    (string= nord-region-highlight "frost") "#88C0D0"
      (if (string= nord-region-highlight "snowstorm") "#D8DEE9" "#151D25")))
  (nord-uniform-mode-lines-background (if nord-uniform-mode-lines "#1E2731" "#0D1319")))

...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;dotspacemacs-startup-banner 007
   dotspacemacs-startup-banner "~/.emacs.d/core/banners/img/emacs-logo-mountain.png"
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (defconst spacemacs-buffer-logo-title "" "")
  ...
  (custom-set-variables
   ;; mountain color scheme, based off dracula format

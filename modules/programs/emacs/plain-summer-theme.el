;;; plain-summer-theme.el --- Light theme without the distractions.
...
(defgroup plainsummer-theme nil
  "Plainsummer-theme options."
  :group 'faces)

(defcustom plainsummer-theme-comment-bg nil
  "Use a background for comment lines."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-comment-italic t
  "Enable italics for comments and also disable background."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-keyword-italic nil
  "Enable italics for keywords."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-org-agenda-height nil
...
(defcustom plainsummer-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-org-bold t
  "Inherit text bold for org headings."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-org-priority-bold t
  "Inherit text bold for priority items in agenda view."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-custom-colors nil
  "Specify a list of custom colors."
  :type 'alist
  :group 'plainsummer-theme)

(defcustom plainsummer-theme-underline-parens t
...
(defun create-plainsummer-theme (theme-name)
  (let ((class '((class color) (min-colors 89)))
    ...
    (cl-loop for (cvar . val) in plainsummer-theme-custom-colors
             do (set cvar val))
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,(if plainsummer-theme-comment-italic comment-light comment) :background ,(when plainsummer-theme-comment-bg comment-bg) :slant ,(if plainsummer-theme-comment-italic 'italic 'normal)))))
     `(font-lock-constant-face ((,class (:foreground ,const))))
     `(font-lock-doc-face ((,class (:foreground ,meta))))
     `(font-lock-function-name-face ((,class (:foreground ,func :inherit bold))))
     `(font-lock-keyword-face ((,class (:inherit bold :foreground ,keyword :slant ,(if plainsummer-theme-keyword-italic 'italic 'normal)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if plainsummer-theme-org-height 1.3 1.0) :background ,(when plainsummer-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if plainsummer-theme-org-height 1.3 1.0) :background ,(when plainsummer-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if plainsummer-theme-org-height 1.3 1.0) :background ,(when plainsummer-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if plainsummer-theme-org-height 1.2 1.0) :background ,(when plainsummer-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if plainsummer-theme-org-height 1.1 1.0) :background ,(when plainsummer-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when plainsummer-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if plainsummer-theme-org-height 1.3 1.0) :background ,(when plainsummer-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if plainsummer-theme-org-height 1.2 1.0) :background ,(when plainsummer-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if plainsummer-theme-org-height 1.1 1.0) :background ,(when plainsummer-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when plainsummer-theme-org-highlight head4-bg)))))
...
;;;;; meow
     ...
     `(meow-position-highlight-number ((,class (:foreground ,bg1 :background ,yellow :inherit bold))))
     `(meow-position-highlight-number-1 ((,class (:foreground ,bg1 :background ,yellow :inherit bold))))
     `(meow-position-highlight-number-2 ((,class (:foreground ,bg1 :background ,yellow :inherit bold))))
     `(meow-position-highlight-number-3 ((,class (:foreground ,bg1 :background ,yellow :inherit bold))))
     `(meow-position-highlight-reverse-number-1 ((,class (:foreground ,bg1 :background ,yellow :inherit bold))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if plainsummer-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if plainsummer-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if plainsummer-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-column ((,class (:background ,highlight :inherit ,(if plainsummer-theme-org-height 'default)))))
     `(org-column-title ((,class (:background ,highlight))))
     `(org-date ((,class (:underline t :foreground ,var))))
     `(org-date-selected ((,class (:background ,func :foreground ,bg1))))
     `(org-document-info-keyword ((,class (:foreground ,meta))))
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if plainsummer-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :bold ,(if plainsummer-theme-org-bold 'unspecified nil) :foreground ,head1 :height ,(if plainsummer-theme-org-height 1.2 1.0) :background ,(when plainsummer-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:bold nil :foreground ,head2 :height ,(if plainsummer-theme-org-height 1.1 1.0) :background ,(when plainsummer-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if plainsummer-theme-org-height 1.05 1.0) :background ,(when plainsummer-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :height ,(if plainsummer-theme-org-height 1.0 1.0) :background ,(when plainsummer-theme-org-highlight head4-bg)))))
     `(org-level-5 ((,class (:bold nil :foreground ,head1 :height ,(if plainsummer-theme-org-height 1.1 1.0)))))
     `(org-level-6 ((,class (:bold nil :foreground ,head2 :height ,(if plainsummer-theme-org-height 1.1 1.0)))))
     `(org-level-7 ((,class (:bold nil :foreground ,head3 :height ,(if plainsummer-theme-org-height 1.1 1.0)))))
     `(org-level-8 ((,class (:bold nil :foreground ,head4 :height ,(if plainsummer-theme-org-height 1.1 1.0)))))
     `(org-link ((,class (:underline t :foreground ,comment))))
     `(org-meta-line ((,class (:foreground ,meta))))
     `(org-mode-line-clock-overrun ((,class (:foreground ,err))))
     `(org-priority ((,class (:foreground ,war :inherit bold :bold ,(if plainsummer-theme-org-priority-bold 'unspecified nil)))))
     `(org-quote ((,class (:inherit org-block :slant italic))))
     `(org-scheduled ((,class (:foreground ,comp))))
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if plainsummer-theme-org-agenda-height 1.2 1.0)))))
...
;;;;; show-paren
     `(show-paren-match ((,class (:foreground ,mat :inherit bold  :underline ,(when plainsummer-theme-underline-parens t)))))
     `(show-paren-match-expression ((,class (:background ,green-bg-s))))
     `(show-paren-mismatch ((,class (:foreground ,err :inherit bold :underline ,(when plainsummer-theme-underline-parens t)))))

;;;;; smartparens
     `(sp-pair-overlay-face ((,class (:background ,highlight :foreground nil))))
     `(sp-show-pair-match-face ((,class (:foreground ,mat :inherit bold  :underline ,(when plainsummer-theme-underline-parens t)))))
...
;;;;; plainsummer-specific
     `(plainsummer-transient-state-title-face ((,class (:background nil :foreground ,comp :box nil :inherit bold))))
...
(deftheme plain-summer "Ditch the rainbow of distraction.")

(create-plainsummer-theme 'plain-summer)

(provide-theme 'plain-summer)

;;; plain-summer-theme.el ends here

;;; plain-grey-theme.el --- Grey theme without the distractions.
...
(defgroup plaingrey-theme nil
  "Plaingrey-theme options."
  :group 'faces)

(defcustom plaingrey-theme-comment-bg nil
  "Use a background for comment lines."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-comment-italic t
  "Enable italics for comments and also disable background."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-keyword-italic nil
  "Enable italics for keywords."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-org-agenda-height nil
...
(defcustom plaingrey-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-org-bold t
  "Inherit text bold for org headings."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-org-priority-bold t
  "Inherit text bold for priority items in agenda view."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-custom-colors nil
  "Specify a list of custom colors."
  :type 'alist
  :group 'plaingrey-theme)

(defcustom plaingrey-theme-underline-parens t
...
(defun create-plaingrey-theme (theme-name)
  (let ((class '((class color) (min-colors 89)))
    ...
    (cl-loop for (cvar . val) in plaingrey-theme-custom-colors
             do (set cvar val))
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,(if plaingrey-theme-comment-italic comment-light comment) :background ,(when plaingrey-theme-comment-bg comment-bg) :slant ,(if plaingrey-theme-comment-italic 'italic 'normal)))))
     `(font-lock-constant-face ((,class (:foreground ,const))))
     `(font-lock-doc-face ((,class (:foreground ,meta))))
     `(font-lock-function-name-face ((,class (:foreground ,func :inherit bold))))
     `(font-lock-keyword-face ((,class (:inherit bold :foreground ,keyword :slant ,(if plaingrey-theme-keyword-italic 'italic 'normal)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if plaingrey-theme-org-height 1.3 1.0) :background ,(when plaingrey-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if plaingrey-theme-org-height 1.3 1.0) :background ,(when plaingrey-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if plaingrey-theme-org-height 1.3 1.0) :background ,(when plaingrey-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if plaingrey-theme-org-height 1.2 1.0) :background ,(when plaingrey-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if plaingrey-theme-org-height 1.1 1.0) :background ,(when plaingrey-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when plaingrey-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if plaingrey-theme-org-height 1.3 1.0) :background ,(when plaingrey-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if plaingrey-theme-org-height 1.2 1.0) :background ,(when plaingrey-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if plaingrey-theme-org-height 1.1 1.0) :background ,(when plaingrey-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when plaingrey-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if plaingrey-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if plaingrey-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if plaingrey-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-column ((,class (:background ,highlight :inherit ,(if plaingrey-theme-org-height 'default)))))
     `(org-column-title ((,class (:background ,highlight))))
     `(org-date ((,class (:underline t :foreground ,var))))
     `(org-date-selected ((,class (:background ,func :foreground ,bg1))))
     `(org-document-info-keyword ((,class (:foreground ,meta))))
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if plaingrey-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :bold ,(if plaingrey-theme-org-bold 'unspecified nil) :foreground ,head1 :height ,(if plaingrey-theme-org-height 1.3 1.0) :background ,(when plaingrey-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :bold ,(if plaingrey-theme-org-bold 'unspecified nil) :foreground ,head2 :height ,(if plaingrey-theme-org-height 1.2 1.0) :background ,(when plaingrey-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if plaingrey-theme-org-height 1.1 1.0) :background ,(when plaingrey-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :background ,(when plaingrey-theme-org-highlight head4-bg)))))
     ...
     `(org-priority ((,class (:foreground ,war :inherit bold :bold ,(if plaingrey-theme-org-priority-bold 'unspecified nil)))))
     `(org-quote ((,class (:inherit org-block :slant italic))))
     `(org-scheduled ((,class (:foreground ,comp))))
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if plaingrey-theme-org-agenda-height 1.2 1.0)))))
...
;;;;; show-paren
     `(show-paren-match ((,class (:foreground ,mat :inherit bold  :underline ,(when plaingrey-theme-underline-parens t)))))
     `(show-paren-match-expression ((,class (:background ,green-bg-s))))
     `(show-paren-mismatch ((,class (:foreground ,err :inherit bold :underline ,(when plaingrey-theme-underline-parens t)))))

;;;;; smartparens
     `(sp-pair-overlay-face ((,class (:background ,highlight :foreground nil))))
     `(sp-show-pair-match-face ((,class (:foreground ,mat :inherit bold  :underline ,(when plaingrey-theme-underline-parens t)))))
...
;;;;; plaingrey-specific
     `(plaingrey-transient-state-title-face ((,class (:background nil :foreground ,comp :box nil :inherit bold))))
...
(deftheme plain-grey "Ditch the rainbow of distraction.")

(create-plaingrey-theme 'plain-grey)

(provide-theme 'plain-grey)

;;; plain-grey-theme.el ends here

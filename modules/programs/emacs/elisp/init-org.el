...
(use-package org
  ...
  (with-eval-after-load 'org-agenda
    ...
    (define-key org-agenda-keymap (kbd "C-c C-h") #'org-agenda-next-date-line)
    (define-key org-agenda-keymap (kbd "C-c C-t") #'org-agenda-previous-date-line)
    (define-key org-agenda-keymap (kbd "C-s") #'org-save-all-org-buffers)
    (define-key org-agenda-keymap (kbd "N") #'org-agenda-clock-in)
    (define-key org-agenda-keymap (kbd "L") #'org-agenda-recenter)
    (define-key org-agenda-keymap (kbd "T") #'org-agenda-previous-item)
    (define-key org-agenda-keymap (kbd "P") #'org-agenda-entry-text-mode)
    (define-key org-agenda-keymap (kbd "H") #'org-agenda-next-item)
    (define-key org-agenda-keymap (kbd "e") #'org-agenda-set-effort)
    (define-key org-agenda-keymap (kbd "h") #'org-agenda-next-line)
    (define-key org-agenda-keymap (kbd "j") #'org-agenda-diary-entry)
    (define-key org-agenda-keymap (kbd "t") #'org-agenda-previous-line)
    (define-key org-agenda-keymap (kbd "b") #'org-agenda-goto-date)
    (define-key org-agenda-keymap (kbd "d") #'org-agenda-earlier)
    (define-key org-agenda-keymap (kbd "f") #'org-agenda-log-mode)
    (define-key org-agenda-keymap (kbd "n") #'org-agenda-later)
    (define-key org-agenda-keymap (kbd "C-z") #'org-agenda-undo)
    (define-key org-agenda-mode-map (kbd "C-c C-n") nil)
    (define-key org-agenda-mode-map (kbd "C-c C-p") nil)
    (define-key org-agenda-mode-map (kbd "C-c C-h") #'org-agenda-next-date-line)
    (define-key org-agenda-mode-map (kbd "C-c C-t") #'org-agenda-previous-date-line)
    (define-key org-agenda-mode-map (kbd "C-s") #'org-save-all-org-buffers)
    (define-key org-agenda-mode-map (kbd "N") #'org-agenda-clock-in)
    (define-key org-agenda-mode-map (kbd "L") #'org-agenda-recenter)
    (define-key org-agenda-mode-map (kbd "T") #'org-agenda-previous-item)
    (define-key org-agenda-mode-map (kbd "P") #'org-agenda-entry-text-mode)
    (define-key org-agenda-mode-map (kbd "H") #'org-agenda-next-item)
    (define-key org-agenda-mode-map (kbd "e") #'org-agenda-set-effort)
    (define-key org-agenda-mode-map (kbd "h") #'org-agenda-next-line)
    (define-key org-agenda-mode-map (kbd "j") #'org-agenda-diary-entry)

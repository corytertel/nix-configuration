...
(use-package org
  ...
  (;; ("C-c o a" . org-agenda-list)
   ...
   ("C-c M-k" . org-insert-last-stored-link)
  ...
  (with-eval-after-load 'org-agenda
    ...
    (define-key org-agenda-keymap (kbd "C-c C-j") #'org-agenda-next-date-line)
    (define-key org-agenda-keymap (kbd "C-c C-k") #'org-agenda-previous-date-line)
    ...
    (define-key org-agenda-keymap (kbd "K") #'org-agenda-previous-item)
    (define-key org-agenda-keymap (kbd "N") #'org-agenda-entry-text-mode)
    (define-key org-agenda-keymap (kbd "J") #'org-agenda-next-item)
    ...
    (define-key org-agenda-keymap (kbd "h") #'org-agenda-earlier)
    ...
    (define-key org-agenda-mode-map (kbd "C-c C-j") #'org-agenda-next-date-line)
    (define-key org-agenda-mode-map (kbd "C-c C-k") #'org-agenda-previous-date-line)

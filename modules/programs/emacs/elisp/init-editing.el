...
(with-eval-after-load 'cc-mode
  ...
  (define-key c-mode-base-map (kbd "C-c C-j") #'c-forward-conditional)
  (define-key c-mode-base-map (kbd "C-c C-p") nil)
  (define-key c-mode-base-map (kbd "C-c C-k") #'c-backward-conditional))

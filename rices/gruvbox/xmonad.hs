...
myStartupHook = do
        ...
        spawnOnce "pcmanfm --desktop &"
        spawnOnce "pcmanfm --set-wallpaper=$HOME/Pictures/wallpaper.jpg &"

------------------------------------------------------------------------

myBar = "xmobar $HOME/.config/xmobar/xmobarrc"

myPP = xmobarPP { ppCurrent = xmobarColor "#ebdbb2" "" . wrap "[" "]" --current selected desktop
                , ppHidden = xmobarColor "#ebdbb2" "" . wrap "" ""
                , ppHiddenNoWindows = xmobarColor "#504945" "" . wrap "" "" --desktops with no windows
                , ppVisible = xmobarColor "#ebdbb2" "" . wrap "" ""
                , ppTitle = xmobarColor "#ebdbb2" "" . shorten 40
                , ppOrder = \(ws:_:_:_) -> [ws]
                }
